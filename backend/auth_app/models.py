...
class CompanyMember(models.Model):
    user = models.ForeignKey("auth_app.CustomUser", on_delete=models.CASCADE, related_name="company_memberships")
    company = models.ForeignKey("crm.Company", on_delete=models.CASCADE, related_name="members")
...
class JoinRequest(models.Model):
    ...
    company = models.ForeignKey("crm.Company", on_delete=models.CASCADE, related_name="join_requests")
...
class Invitation(models.Model):
    ...
    company = models.ForeignKey("crm.Company", on_delete=models.CASCADE, related_name="invitations")
